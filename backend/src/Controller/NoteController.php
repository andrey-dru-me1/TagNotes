...
class NoteController extends AbstractController
{
  ...
  public function filterNotes(Request $request, #[CurrentUser] ?User $user)
  {
  ...
  #[
    Route(
      "/api/note/{noteId}/tag/{tagId}",
      name: "remove_tag",
      methods: ["DELETE"]
    )
  ]
  public function removeTag(int $noteId, int $tagId): Response
  {
  ...
  public function appendTag(int $noteId, int $tagId): Response
  {
